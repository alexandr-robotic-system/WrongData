...
Static website ready for GitHub Pages. No build process or backend is required.

## Publish with GitHub Pages

1. Create a GitHub repository named `wrong-data-website`.
2. Upload **the contents of this folder** (not the folder itself) into the repository root.
